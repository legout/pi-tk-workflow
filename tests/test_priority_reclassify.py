...
class TestGetTicketIds:
    ...
    @patch("tf.priority_reclassify.run_tk_command")
...
class TestMainArgumentParsing:
    ...
    def test_no_project_found(self, mock_which):
        ...
        with patch("tf.priority_reclassify.find_project_root") as mock_find:
...
class TestClosedTicketHandling:
    ...
    @patch("shutil.which")
    @patch("tf.priority_reclassify.find_project_root")
    @patch("tf.priority_reclassify.run_tk_command")
...
Description."""
    ...
    @patch("tf.priority_reclassify.find_project_root")
    @patch("tf.priority_reclassify.run_tk_command")
    @patch("tf.priority_reclassify.print_results")
    @patch("tf.priority_reclassify.write_audit_trail")
...
# Test ticket"""
        ...
        with patch("tf.priority_reclassify.print_results") as mock_print:
            with patch("tf.priority_reclassify.write_audit_trail"):
    ...
    @patch("shutil.which")
    @patch("tf.priority_reclassify.find_project_root")
    @patch("tf.priority_reclassify.get_ticket_ids_from_ready")
    @patch("tf.priority_reclassify.run_tk_command")
...
# Ready ticket"""
    ...
    @patch("shutil.which")
    @patch("tf.priority_reclassify.find_project_root")
    @patch("tf.priority_reclassify.get_ticket_ids_by_status")
    @patch("tf.priority_reclassify.run_tk_command")
...
# Open ticket"""
    ...
    @patch("shutil.which")
    @patch("tf.priority_reclassify.find_project_root")
    @patch("tf.priority_reclassify.get_ticket_ids_by_tag")
    @patch("tf.priority_reclassify.run_tk_command")
...
Description with no keywords."""
    ...
    @patch("tf.priority_reclassify.find_project_root")
    @patch("tf.priority_reclassify.run_tk_command")
    @patch("tf.priority_reclassify.is_interactive")
    @patch("tf.priority_reclassify.confirm_changes")
...
class TestIntegration:
    ...
    def test_help_output(self):
        ...
        result = subprocess.run(
            ["python", "-m", "tf.priority_reclassify", "--help"],
            capture_output=True,
            text=True,
        )
